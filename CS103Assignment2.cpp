...
void StudentGradeSum(vector<Student>& tempStudent) {
	...
	for (i = 0; i < tempStudent.size(); i++) {
		if (tempStudent[i].ID == IDsearch && tempStudent[i].Password == recPassword) {
			...
			cout << "In total your average was " << average << "%" << endl;
			int MarkAve = average;
...
void studentTuitionSum(vector<Student>& tempStudent) {
	...
	for (i = 0; i < tempStudent.size(); i++) {
		if (tempStudent[i].ID == IDsearch && tempStudent[i].Password == recPassword) {
			...
			cout << "\n - Totals -\n\n";
			SetConsoleTextAttribute(color, 15);
			cout << "In total you have 4 papers.Your total Semester Cost =  $NZD " << tempStudent[i].class1.courseCost + tempStudent[i].class2.courseCost + tempStudent[i].class3.courseCost + tempStudent[i].class4.courseCost << endl;
